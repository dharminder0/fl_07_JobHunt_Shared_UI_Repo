    ...
    <div className="p-6">
      ...
      <div className="mb-6 ">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <p className="text-heading">OpsTree Solutions</p>
      ...
      <Grid container spacing={6}>
        ...
        <Grid item xs={12} md={3}>
          ...
          <div className="mt-4">
            <h5 className="text-heading mb-2">Social Links</h5>
            <ul className="text-gray-700 text-base">
              <li>
                <Link
              ...
              <li>
                <Link href="https://www.linkedin.com/company/opstree-solutions/" underline="none">

              ...
              {filteredApplicants.map((applicant, index) => (
                ...
                >
                  ...
                  <td className="wide-250 cursor-pointer" >
                    <div className="flex" onClick={() => handleRowClick(applicant.id,'vendor')}>
                      <img
                  ...
                  <td className="wide-250 cursor-pointer" onClick={() => handleRowClick(applicant.id,'client')}>
                    <div className="flex">
                      <img
                  ...
                  <td>
                    <Typography
                      className={`inline-block px-3 py-1 !text-base rounded-full ${applicant.status === "Hired"

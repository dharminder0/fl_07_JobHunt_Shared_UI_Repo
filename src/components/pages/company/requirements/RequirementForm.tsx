              ...
              <div className="mt-4">
                ...
                {tabValue === "recommendation" && (
                  <div className="mt-2">
                                ...
                                >
                                  <div
                                    className={`h-100 border p-3 rounded-md cursor-pointer ${
                                      isCardSelected(company, "relatedOrgCode")
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          {companiesfilterData.map((company, idx) => (
                            <div
                              key={idx}
                              onClick={() =>
                                handleCardClick(company, "orgCode")
                              }
                            >
                              <div
                                className={`h-100 border p-3 rounded-md cursor-pointer ${
                                  isCardSelected(company, "orgCode")
                                    ? "!bg-indigo-100 border-indigo-600"
                                    : ""
                                }`}
                              >
                    ...
                    {isVendorLoader && !isLoader && (
                      <>
                        <Loader subText1="Ai is searching for best vendors..." />
                      </>
                    )}
                  </div>
                )}

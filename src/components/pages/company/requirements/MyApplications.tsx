...
const MyApplications = () => {
  ...
  return (
    <Box className="p-6  min-h-screen font-display">
      {/* Header */}
      <Box className="flex justify-between items-center mb-6">
        <Box>
          <div className="font-display text-[24px]/[28.8px] leading-h5 font-semibold">Requirements Listing</div>
          ...
          <TableBody>
            {jobData.map((job, index) => (
              ...
              >
                ...
                <TableCell>
                  <Typography
                    className={`inline-block px-3 py-1 text-sm font-medium rounded-full ${job.status === "Open"
...
>>>>>>> d64b5e5b48289b3fc844e5ab85210800dc0a66d2
                ...
                <TableCell>{job.contractPeriod}</TableCell>
                <TableCell>{job.applicants}</TableCell>
                <TableCell>{job.visibility}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
